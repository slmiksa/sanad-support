...
النشر السريع الموصى به (دون إدخال مفاتيح)
------------------------------------------
من داخل مجلد المشروع شغّل فقط:

  git pull
  npm run deploy:server

يبني الأمر الموقع وينسخه إلى /home/sanad.lamhasec.com/public_html تلقائياً.
المصادقة الثنائية والإشعارات تُرسل عبر خادم سند الآمن، لذلك لا تحتاج إلى
إضافة RESEND_API_KEY أو SUPABASE_SERVICE_ROLE_KEY على السيرفر الخارجي.

إذا كان مجلد الموقع مختلفاً:

  SANAD_PUBLIC_HTML=/المسار/إلى/public_html npm run deploy:server
